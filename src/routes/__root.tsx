...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "syncMind CRM" },
      { name: "description", content: "syncMind CRM Demo" },
    ],
    links: [
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `document.documentElement.style.opacity='0';window.addEventListener('DOMContentLoaded',function(){requestAnimationFrame(function(){document.documentElement.style.opacity='1';document.documentElement.style.transition='opacity 0.1s'})})`,
          }}
        />
      </head>
